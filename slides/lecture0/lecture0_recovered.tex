...
\begin{frame}[t]{Foundations of Machine Learning}
...
\begin{itemize}
	...
	\item Data: where does the datasets come from? 
	\vspace{0.2cm}
	\begin{itemize}
		\item[] 
		\item[] 
	\end{itemize}
	\item Candidate set of models: which models are plausible?
		\vspace{0.2cm}
	\begin{itemize}
		\item[] 
		\item[] 
	\end{itemize}
	\item Learning algorithm: how to find the best model to fit the data?
	\vspace{0.2cm}
	\begin{itemize}
		\item[] 
		\item[] 
...
\begin{frame}[t]{Foundations of Machine Learning}
	...
	\begin{itemize}
		...
		{\large
			...
			\vspace{0.2cm}
			\begin{itemize}
				\item Simple model: linear regression, kernel methods
				\item Complex model: deep networks
			\end{itemize}
			\item Learning algorithm: how to find the best model to fit the data?
			\vspace{0.2cm}
			\begin{itemize}
