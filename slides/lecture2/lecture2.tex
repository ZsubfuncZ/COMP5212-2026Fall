...
\begin{frame}
  \centering
  \vspace*{0.88cm}
  {\fontsize{34}{40}\selectfont\bfseries Hypothesis Sets and PAC Learning\par}
  \vspace{0.45cm}
  ...
  Based on Chapter 2 of \emph{Foundations of Machine Learning}, 2nd ed.\par}
  \vfill
  {\small Mehryar Mohri, Afshin Rostamizadeh, and Ameet Talwalkar (MIT Press, 2018)\par}
\end{frame}
...
\begin{frame}[t]{From Data to a Predictor}
  ...
  \begin{tikzpicture}[
    ...
    \draw[arr] (dist) -- node[above,midway]{i.i.d. draw} (sample);
...
\begin{frame}[t]{Formal Setup}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    ...
    \end{column}
  \end{columns}
  \SourceNote{Notation follows Mohri, Rostamizadeh, and Talwalkar (2018), Chapter 2.}
\end{frame}
